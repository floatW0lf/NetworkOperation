...
namespace NetOperationTest
{
    ...
    #pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        namespace UniRx
        {
            ...
            public UniTask<T> WaitUntilValueChangedAsync(CancellationToken cancellationToken)
            {
                ...
                {
                    removablePromises =
 new Dictionary<CancellationToken, ReactivePropertyReusablePromise<T>>(CancellationTokenEqualityComparer.Default);
                }
 ...
 new Dictionary<CancellationToken, ReactivePropertyReusablePromise<T>>(CancellationTokenEqualityComparer.Default);
            ...
            public static UniTask<T>.Awaiter GetAwaiter<T>(this IReadOnlyReactiveProperty<T> source)
            {
                ...
                /// </summary>
                public static ReadOnlyReactiveProperty<T> ToSequentialReadOnlyReactiveProperty<T>(
