var LibraryWebSocket = {
	...
	WebSocketSetOnOpen: function(callback) {
		...
		webSocketState.onOpen = getFuncWrapper(callback, 'vi');
	...
	WebSocketSetOnMessage: function(callback) {
		...
		webSocketState.onMessage = getFuncWrapper(callback, 'viii');
	...
	WebSocketSetOnError: function(callback) {
		...
		webSocketState.onError = getFuncWrapper(callback, 'vii');
	...
	WebSocketSetOnClose: function(callback) {
		...
		webSocketState.onClose = getFuncWrapper(callback, 'vii');
	...
	WebSocketConnect: function(instanceId) {
		...
		instance.ws.onerror = function(ev) {
			...
			if (webSocketState.onError) {
				...
				try {
					webSocketState.onError(instanceId, msgBuffer);					
				} finally {
					_free(msgBuffer);
				}
...
autoAddDeps(LibraryWebSocket, '$getFuncWrapper');
